...
const Header = () => (
  <header className="w-full px-6 py-4 flex justify-between items-center bg-white">
    ...
    <nav className="hidden md:flex items-center gap-6">
      <div className="text-black text-base font-semibold font-['Inter']">Home</div>
      <div className="text-black text-base font-semibold font-['Inter']">About</div>
      <div className="text-black text-base font-semibold font-['Inter']">Tournaments</div>
      <div className="text-black text-base font-semibold font-['Inter']">Contact</div>
    </nav>
    <div className="px-4 py-2 bg-[#fff5d2] rounded-[33px] border border-[#7f7f7f] flex items-center justify-center">
